...
class Classifier_with_OneHotEncoding_BalancedBaggingClassifier(AbstractClassifier):

    def __init__(self, options):
        super(Classifier_with_OneHotEncoding_BalancedBaggingClassifier, self).__init__()
...
if __name__ == '__main__':
    ...
    decisiontree_classification = Classifier_with_OneHotEncoding_BalancedBaggingClassifier(options)
